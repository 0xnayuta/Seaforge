...
| Server Action | `src/app/actions/dungeon.ts` | ✅ 已完成 |
| UI 组件 | `src/components/DungeonPanel.tsx` | ✅ 已完成 |
| 路由页面 | `src/app/dungeon/page.tsx` | ✅ 已完成 |
...
| UI | `src/components/CraftingPanel.tsx` | ✅ 已完成 |
...
| 路由页面 | `src/app/achievements/page.tsx` | ✅ 已完成 |
...
| Server Action 集成 | — | `updateCollection` ✅ 已在全部 14 个 Action 中集成 |
| UI 路由页面 | `src/app/collection/page.tsx` | ✅ 已完成 |
...
以下四个子系统的 Server Action、UI 组件、路由页面及 `updateCollection` 集成均已实现并经过测试：

| 子系统 | 关键文件 | 状态 |
|--------|----------|------|
| 副本系统 | `src/app/actions/dungeon.ts` · `src/components/DungeonPanel.tsx` · `src/app/dungeon/page.tsx` | ✅ 全部完成 |
| 装备合成 | `src/app/actions/crafting.ts` · `src/components/CraftingPanel.tsx` | ✅ 全部完成 |
| 成就系统 | `src/app/actions/achievement.ts` · `src/app/achievements/page.tsx` | ✅ 全部完成 |
| 图鉴系统 | `src/game/domain/collection.ts` · `src/app/collection/page.tsx` · 14 个 Action 集成 updateCollection | ✅ 全部完成 |
